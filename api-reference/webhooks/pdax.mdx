---
title: PDAX Webhook
api: POST /api/pdax/webhook
description: Receive onramp transaction updates from PDAX
---

Tracks onramp transactions, updates payout status, and triggers offramp when onramp completes.
